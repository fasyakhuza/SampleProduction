...
def create_jobs(input_rootfiles):
	...
	os.mkdir(dir_name)
	#out_txtfile= open(os.path.join(output_dir,str(input_rootfiles).replace('reco','miniaod')),'w')
	...
	for i in range(len(filename)):
		...
		shutil.copyfile("../skeleton/MiniAOD_basefile_run.py",os.path.join(run_dir,sim_cfg_file))
